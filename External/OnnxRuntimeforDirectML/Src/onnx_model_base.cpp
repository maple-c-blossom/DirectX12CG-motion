...
{
    std::string strProvider = provider;
    ...
    if(strProvider == OnnxProviders::DIRECTML)
    {
    ...
    if (strProvider == OnnxProviders::CUDA) {  // strcmp(provider, OnnxProviders::CUDA.c_str()) == true strcmp(provider, "cuda") // (providerStr == "cuda")
    ...
    else if (strProvider == OnnxProviders::CPU) {  // strcmp(provider, OnnxProviders::CPU.c_str()) == true) (providerStr == "cpu") {
        // "cpu" by default
    }
    else if(strProvider == OnnxProviders::DIRECTML){
    }
    else
    {
